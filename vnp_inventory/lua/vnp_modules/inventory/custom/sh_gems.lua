...
GEM.OnHit = function(target, item, wep, dmginfo) -- The function that runs when you hit your enemy...
    ...
    -- if chance <= item.Modifiers["firechance"] then
...
GEM.Hooks = {
    ["ShouldIgnite"] = function(ply)
        ...
        --     if gem.Modifiers and gem.Modifiers["fireresist"] then
        --         if chance <= gem.Modifiers["fireresist"] then return true end
        --     end
        -- end
    end,
}
...
GEM.OnHit = function(target, item, wep, dmginfo) -- The function that runs when you hit your enemy...
    ...
    if chance <= item.Modifiers["poisonchance"] then
        ...
        damageDOT(target, ply, 1, 0.2, 25, Color(100, 200 + math.random() * 55, 100), function(pl)
            ...
            for name,gem in pairs(data.Sockets) do
                if gem.Modifiers and gem.Modifiers["poisonresist"] then
                    if chance <= gem.Modifiers["poisonresist"] then return false end
                end
            end
...
GEM.OnHit = function(target, item, wep, dmginfo) -- The function that runs when you hit your enemy...
    ...
    -- if chance <= item.Modifiers["lifesteal"] then
...
GEM.Hooks = {
    ["shouldLifeSteal"] = function(ply)
        ...
        for name,gem in pairs(data.Sockets) do
            if gem.Modifiers and gem.Modifiers["resistlifesteal"] then
                if chance <= gem.Modifiers["resistlifesteal"] then return true end
            end
        end
    end,
}
...
GEM.OnHit = function(target, item, wep, dmginfo) -- The function that runs when you hit your enemy...
    ...
    if chance <= item.Modifiers["voidchance"] then
...
GEM.Hooks = {
    ["shouldVoid"] = function(ply)
        ...
        for name,gem in pairs(data.Sockets) do
            if gem.Modifiers and gem.Modifiers["resistvoid"] then
                if chance <= gem.Modifiers["resistvoid"] then return true end
            end
        end
    end,
}
...
GEM.Description = "Hits to arrest."
...
GEM.OnPlayerDeath = function(ply, item, gem, socket)
    ...
    if chance <= gem.Modifiers["regainchance"] then
        item.Sockets[socket] = nil
        
        item.Sockets[1] = VNP.Inventory:CreateItem("", "")
        item.Sockets[2] = VNP.Inventory:CreateItem("", "")
        item.Sockets[3] = VNP.Inventory:CreateItem("", "")
        item.Sockets[4] = VNP.Inventory:CreateItem("", "")
        item.Sockets[5] = VNP.Inventory:CreateItem("", "")
        item.Sockets[6] = VNP.Inventory:CreateItem("", "")
        item.Sockets[7] = VNP.Inventory:CreateItem("", "")
...
GEM.Hooks = {
    ["shouldParalyze"] = function(ply)
        ...
        for name,gem in pairs(data.Sockets) do
            if gem.Modifiers and gem.Modifiers["paralyzeresist"] then
                if chance <= gem.Modifiers["paralyzeresist"] then return true end
            end
        end
    end,
...
GEM.OnHit = function(target, item, wep, dmginfo) -- The function that runs when you hit your enemy...
    ...
    if chance <= item.Modifiers["radiatechance"] then
        damageDOT(target, ply, 1, 0.1, 50, Color(200 + math.random() * 55, 100, 100), function(pl)
            ...
            for name,gem in pairs(data.Sockets) do
                if gem.Modifiers and gem.Modifiers["radiateresist"] then
                    if chance <= gem.Modifiers["radiateresist"] then return false end
                end
            end
...
GEM.OnHit = function(target, item, wep, dmginfo) -- The function that runs when you hit your enemy...
    ...
    if chance <= item.Modifiers["electrocutechance"] then
        ...
        for _,pl in ipairs(players) do
            ...
            damageDOT(pl, ply, 6, 1, 3, nil, function(pl)
                ...
                for name,gem in pairs(data.Sockets) do
                    if gem.Modifiers and gem.Modifiers["electrocuteresist"] then
                        if chance <= gem.Modifiers["electrocuteresist"] then return false end
                    end
                end
...
--     if chance <= item.Modifiers["freezechance"] then
...
GEM.Hooks = {
    ["shouldFreeze"] = function(ply)
        ...
        for name,gem in pairs(data.Sockets) do
            if gem.Modifiers and gem.Modifiers["freezeresist"] then
                if chance <= gem.Modifiers["freezeresist"] then return true end
            end
        end
    end,
    ["PlayerDeath"] = function(ply)
