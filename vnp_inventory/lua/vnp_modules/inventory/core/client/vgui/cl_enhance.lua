...
function PANEL:Init() // A little bit aids but hey it works perfectly
    ...
    self.itemSlot:SetResPos((w/2)-(itemSlotSize/2),70)
    ...
    self.scrollSlot:SetResPos((w/2)-itemSlotSize-(scrollSlotSize/2),70+(itemSlotSize-scrollSlotSize)/2)
    ...
    self.gemSlot:SetResPos((w/2)+itemSlotSize-(scrollSlotSize/2),70+(itemSlotSize-scrollSlotSize)/2)
    ...
    self.enhanceConfirm = vgui.Create("VNPButton", self)
    self.enhanceConfirm:SetResSize(w*.75,40)
    self.enhanceConfirm:SetResPos(w/2-(w*.75)/2, h-(50))
    self.enhanceConfirm:SetText("Enhance")
    self.enhanceConfirm:SetBGCol(Color(15,15,17,255))
